                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-item-add">POST api/item/add</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-items-update--id-">
                                <a href="#endpoints-PUTapi-items-update--id-">PUT api/items/update/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-item-delete--id-">
                                <a href="#endpoints-DELETEapi-item-delete--id-">DELETE api/item/delete/{id}</a>
                            </li>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-items-update--id-">PUT api/items/update/{id}</h2>
...
<div class="bash-example">
    ...
    "http://localhost/api/items/update/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the update. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-item-delete--id-">DELETE api/item/delete/{id}</h2>
...
<div class="bash-example">
    ...
    "http://localhost/api/item/delete/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
